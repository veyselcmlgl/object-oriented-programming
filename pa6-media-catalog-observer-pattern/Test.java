public class Test {
    public static void main(String[] args) {
        ...
        p0.info();  /* prints the information of the object */
        ...
        System.out.println("\nCurrent Player object information:");
        Playable plyr0 = p2.currently_playing();
        plyr0.info();
        System.out.println();

        System.out.println("\nCurrent Player object information after next(video):");
        ...
        System.out.println("\nCurrent Player object information after previous(video):");
        ...
        System.out.println("\nCurrent Viewer object information:");
        Non_playable viewer0 = v2.currently_viewing();
        viewer0.info();
        System.out.println();

        System.out.println("\nCurrent Viewer object information after next(text):");
        v2.next("text");   /* go to next viewer object type of the text */
        viewer0 = v2.currently_viewing();
        viewer0.info();
        System.out.println();
        ...
        System.out.println("\nCurrent Viewer object information after previous(text):");
        ...
        System.out.println("\nCurrent Player object information after next(audio):");
        p2.next("audio");  /* go to next player object type of the audio */
        plyr0 = p2.currently_playing();
        plyr0.info();
        System.out.println();

        System.out.println("\nCurrent Player object information after previous(audio):");
        ...
        System.out.println("\nCurrent Viewer object information after next(image):");
        v2.next("image");   /* go to next viewer object type of the image */
        viewer0 = v2.currently_viewing();
        viewer0.info();
        System.out.println();

        System.out.println("\nCurrent Viewer object information after previous(image):");
